...
public class UpcomingWorkoutDialog extends BottomSheetDialogFragment {
    ...
    public static UpcomingWorkoutDialog newInstance(List<WorkoutAdapter.WorkoutItem> workouts) {
        UpcomingWorkoutDialog dialog = new UpcomingWorkoutDialog();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R. layout.dialog_upcoming_workouts_coach, container, false);
    }
